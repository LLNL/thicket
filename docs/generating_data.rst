...
This command generates a "measurements" directory. Thicket cannot read
...
directory in the format recognizable by thicket.
...
configurations <https://software.llnl.gov/Caliper/BuiltinConfigurations.htm>`_ customized for thicket: ``thicket-region-profile`` or
``thicket-sample-profile``. The former generates a profile based on user
...
``CALI_CONFIG=thicket-sample-profile``).
...
pyinstrument
============
Thicket can read `pyinstrument <https://github.com/joerick/pyinstrument>`_ JSON
