...
;// CONCATENATED MODULE: ./scripts/globals.js
...
;// CONCATENATED MODULE: ./scripts/topdown/stackedbars.js
...
var StackedBars = /*#__PURE__*/function () {
  ...
  _createClass(StackedBars, [{
    ...
    value: function getGroupedRecords() {
      ...
      try {
        var _loop = function _loop() {
          ...
          var row = _this.records.filter(function (r) {
            return r.nid == n.nid;
          });

          row.sort(function (f1, f2) {
            return f1[_this.magic_ordinal] > f2[_this.magic_ordinal];
          });
          var gr = [];

          var _iterator3 = _createForOfIteratorHelper(_this.ordinal_groups),
              _step3;
          ...
          try {
            var _loop2 = function _loop2() {
              ...
              gr.push({
                'ordinal': g,
                'data': row.filter(function (r) {
                  return r[_this.magic_ordinal] == g;
                })
              });
            };
    ...
    key: "getOrdinalGroups",
    value: function getOrdinalGroups() {
      var grps = [];
      var freq = {};

      var _iterator4 = _createForOfIteratorHelper(this.records),
          _step4;
    ...
    key: "test_normalize",
    value: function test_normalize(data) {
      ...
      try {
        for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
          ...
          var _iterator6 = _createForOfIteratorHelper(this.topdown_vars),
              _step6;
          ...
          if (sum > 1) {
            var _iterator7 = _createForOfIteratorHelper(this.topdown_vars),
                _step7;
    ...
    key: "get_unique_profs",
    value: function get_unique_profs(dataframe, id) {
      var profs = [];
      var node_records = dataframe.filter(function (r) {
        return r.nid == id;
      });

      var _iterator8 = _createForOfIteratorHelper(node_records),
          _step8;
    ...
    key: "get_unique_nodes",
    value: function get_unique_nodes(dataframe) {
      var uniques = [];
      var test = [];

      var _iterator9 = _createForOfIteratorHelper(dataframe),
          _step9;
    ...
    key: "set_height",
    value: function set_height(h) {
      this.height = h;
      this.svg.attr('height', this.height);
    }
  }, {
    key: "set_width",
    value: function set_width(w) {
      this.width = w;
      this.svg.attr('width', this.width);
    }
  }, {
    key: "set_row_scale",
    value: function set_row_scale(rs) {
      this.chart_row_scale = rs;
    }
  }, {
    key: "set_row_ordering_map",
    value: function set_row_ordering_map(om) {
    ...
    value: function render() {
      ...
      this.svg.selectAll('.chart_rows').data(this.uniques).join(function (enter) {
        ...
        return row;
      }).selectAll('.ordinal-groups').data(function (d) {
        d.records.sort(function (r1, r2) {
          return r1['ordinal'] > r2['ordinal'];
        });
        return d.records;
      }).join(function (enter) {
        var grp = enter.append('g').attr('class', 'ordinal-groups').attr('transform', function (_, i) {
          return "translate(".concat(_this2.bar_x_scale(i), ",0)");
        });
        grp.append('text').attr('class', 'bottom-axis-group-label').attr('text-anchor', 'middle').attr('transform', function (_, i) {
          return "translate(".concat(_this2.inner_group_width / 2 + _this2.group_margins / 2, ", ").concat(_this2.bar_chart_height, ")");
        }).text(function (d) {
          return "".concat(d.ordinal);
        });
        return grp;
      }).selectAll('.stacked-bar').data(function (d) {
        var recs = d.data;
        recs.sort(function (f1, f2) {
          return f1[_this2.sortvar] > f2[_this2.sortvar];
        });
        return recs;
      }).join(function (enter) {
        ...
        var _iterator10 = _createForOfIteratorHelper(self.topdown_vars),
            _step10;
        ...
        pivot.sort(function (f1, f2) {
          if (f1.varname == _this2.sortvar) {
            return 1;
          } else {
            return 0;
          }
        ...
        var sub_bars = enter.append('rect').attr('width', Math.min(_this2.bar_width, 20)).attr('class', function (d) {
          "".concat(d.varname, "-bar");
        }).attr('class', 'bar-portion').attr('stroke-width', 1).attr('stroke', 'black').attr('fill', function (d) {
...
;// CONCATENATED MODULE: ./scripts/treetable.js
function treetable_createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = treetable_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }

function treetable_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return treetable_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return treetable_arrayLikeToArray(o, minLen); }

function treetable_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
function treetable_createClass(Constructor, protoProps, staticProps) { if (protoProps) treetable_defineProperties(Constructor.prototype, protoProps); if (staticProps) treetable_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var TreeTable = /*#__PURE__*/function () {
  ...
  treetable_createClass(TreeTable, [{
    key: "link_path",
    value: function link_path(node, parent) {
      //array of 3 coords
      //to make angled link between nodes
      //drawn from child to parent
      var coords = [{
        x: this.x_scale(node.layout.depth),
        y: this.y_scale(node.layout.order)
      }, {
        x: this.x_scale(node.layout.depth - 1),
        y: this.y_scale(node.layout.order)
      }, {
        x: this.x_scale(node.layout.depth - 1),
        y: this.y_scale(parent.layout.order)
      }];
      var line = src_line().x(function (coord) {
        return coord.x;
      }).y(function (coord) {
        return coord.y;
      });
    ...
    value: function render() {
      ...
      this.tree_grp.selectAll('.nodes').data(Object.values(this.indented_tree)).join(function (enter) {
        ...
        node.append('circle').attr('r', 8).attr('fill', 'rgba(125,50,50,1)');
        return node;
      });
      this.tree_grp.selectAll('.links').data(Object.values(this.indented_tree)).join(function (enter) {
        enter.append('path').attr('class', 'links').attr("d", function (d) {
...
var TreeModel = /*#__PURE__*/function () {
  function TreeModel(tree_def) {
    treetable_classCallCheck(this, TreeModel);

    this.tree = tree_def;
    this.depth = 0;

    for (var id in this.tree) {
      this.tree[id].id = id;
    }
  }

  treetable_createClass(TreeModel, [{
    key: "recursive_indented_tree_layout",
    value: function recursive_indented_tree_layout(tree, node, order, depth) {
      node.layout = {};
      ...
      var _iterator = treetable_createForOfIteratorHelper(node.children),
          _step;
    ...
    key: "indented_tree",
    value: function indented_tree() {
      var tree_cpy = JSON.parse(JSON.stringify(this.tree));
      var nodes = [];
      var total_offset = 0;

      for (var node in tree_cpy) {
...
var topdown_RT = window.Roundtrip;
var topdown_data = JSON.parse(topdown_RT['topdown_data']);
var tree_model = new TreeModel(topdown_data.graph[0]);
var tree_max_w = element.offsetWidth;
var tree_max_h = window.innerHeight * .9;
var tree_div = src_select("#plot-area");
var TB = new TreeTable(tree_div, tree_max_w, tree_max_h, tree_model, topdown_data);
TB.render();
/******/ })()
;