...
def test_display_histogram(rajaperf_seq_O3_8M_cali):
    tk = th.Thicket.from_caliperreader(rajaperf_seq_O3_8M_cali)
...
def test_display_heatmap(rajaperf_seq_O3_8M_cali):
    tk = th.Thicket.from_caliperreader(rajaperf_seq_O3_8M_cali)
...
def test_display_boxplot(rajaperf_seq_O3_8M_cali):
    tk = th.Thicket.from_caliperreader(rajaperf_seq_O3_8M_cali)
